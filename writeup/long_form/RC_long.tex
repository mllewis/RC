...
We ask whether speakers reason the same way about the meanings of words, breaking the symmetry between two unknown meanings by reference to length.  Specifically, we test the following hypothesis: 
...
\label{my-label}
\begin{tabular}{@{}lllll@{}}
\multicolumn{1}{c}{{\bf Experiment}} & \multicolumn{1}{c}{{\bf Description}} & \multicolumn{1}{c}{{\bf \begin{tabular}[c]{@{}c@{}}Complexity Hypothesis\\ Tested\end{tabular}}} & \multicolumn{1}{c}{{\bf Object Stimuli Type}}                                          & \multicolumn{1}{c}{{\bf Comprehension/Production}} \\
\rowcolor[HTML]{EFEFEF} 
1                                    & Explicit complexity norms             & 1                                                                                                & artificial objects                                                                     & NA                                                 \\
2                                    & Mapping task                          & 1                                                                                                & artificial objects                                                                     & comprehension                                      \\
\rowcolor[HTML]{EFEFEF} 
3                                    & Mapping task (control)                & 1                                                                                                & artificial objects                                                                     & comprehension                                      \\
4                                    & Explicit complexity norms             & 1                                                                                                & novel real objects                                                                     & NA                                                 \\
\rowcolor[HTML]{EFEFEF} 
{\color[HTML]{333333} 5}             & {\color[HTML]{333333} Mapping task}   & {\color[HTML]{333333} 1}                                                                         & {\color[HTML]{333333} novel real objects}                                              & {\color[HTML]{333333} comprehension}               \\
6                                    & Mapping task (control)                & 1                                                                                                & novel real objects                                                                     & comprehension                                      \\
\rowcolor[HTML]{EFEFEF} 
7                                    & Production                            & 1                                                                                                & novel real objects                                                                     & production                                         \\
8                                    & Memory task to elicit RTs             & 1                                                                                                & \begin{tabular}[c]{@{}l@{}}artifical objects (a)\\ novel real objects (b)\end{tabular} & NA                                                 \\
\rowcolor[HTML]{EFEFEF} 
9                                    & English complexity norms              & 2                                                                                                & NA                                                                                     & NA                                                 \\
10                                   & Cross-linguistic corpus analysis      & 2                                                                                                & NA                                                                                     & NA                                                
\end{tabular}
\end{table}

ENUMERATION OF STUDY PACKAGES


In Experiments 1-7, we   test whether participants are biased to map a relatively long novel word onto a relatively more complex object, using artificial objects (Experiments 1-3) and novel, real objects (Experiments 4-7). In Experiment 8, we explore the underlying cognitive construct of complexity in a reaction time task. Finally, we examine a complexity bias in natural language by eliciting complexity norms for English words (Experiment 9) and conducting a corpus analysis of 79 additional languages. We find a robust complexity bias in both novel words and natural language.



\section{Experiment 1: Object Complexity Norms (Artificial Objects)}
% \section{Experiments 1--3: Complexity Bias in Comprehension (Artificial objects)} 
...
\subsection{Experiment 3: Control Mapping Task (Artificial Objects)}
...
\subsubsection{Procedure}
Participants completed six forced-choice trials identical to Experiment 1b. 
...
\subsection{Experiment 4: Object Complexity Norms (Novel Objects)}
...
\section{Experiment 7: Production Task (Novel Objects)}
...
TIMESCALES - COMPLEXITY1 COMPLEXTY2 relationship?
