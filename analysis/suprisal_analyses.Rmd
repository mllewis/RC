...
bnc.1gram = read.table('../data/corpus/English-KNN-H-1.txt', header = T) %>%
  mutate(log.bnc.frequency = log(context.count)) %>%
  top_n(25000, abs(log.bnc.frequency)) # following Piantadosi, resttrict to most frequent words
...
# get correlations
full.piantadosi.df = rbind(tidy(cor.test(bnc.1gram$len, bnc.1gram$log.bnc.frequency, method = "spearman")),
                           tidy(cor.test(bnc.1gram$len, bnc.1gram$subt.log.freq, method = "spearman")),
                           tidy(cor.test(bnc.1gram$len, bnc.1gram$surprisal, method = "spearman")))
full.piantadosi.df$corr = c("freq.bnc", "freq.subt", "surprisal")
full.piantadosi.df$words = "all words"

# get partial correlations
full.p.cor.surp.f.bnc = pcor.test(bnc.1gram$len, bnc.1gram$surprisal, bnc.1gram$log.bnc.frequency, method = "spearman")$estimate
full.p.cor.surp.f.subt = pcor.test(bnc.1gram$len, bnc.1gram$surprisal, bnc.1gram$subt.log.freq, method = "spearman")$estimate
full.p.cor.freq.bnc.s = pcor.test(bnc.1gram$len, bnc.1gram$log.bnc.frequency,bnc.1gram$surprisal, method = "spearman")$estimate
full.p.cor.freq.subt.s = pcor.test(bnc.1gram$len, bnc.1gram$subt.log.freq,bnc.1gram$surprisal, method = "spearman")$estimate
...
ggplot(both.piantadosi.df) +
  ...
  #geom_linerange(aes(ymax=abs(conf.high), ymin=abs(conf.low), x = corr),
...
```{r, echo = F, fig.width = 11}
bnc.3gram = read.table('../data/corpus/English-KNN-H-3.txt', header = T) %>%
  mutate(log.bnc.frequency = log(context.count)) %>%
  top_n(25000, abs(log.bnc.frequency)) # following Piantadosi, resttrict to most frequent words
...
p.cor.surp.f.bnc = pcor.test(lf.data$nchars, lf.data$surprisal, lf.data$log.bnc.frequency, method = "spearman")$estimate
p.cor.surp.f.subt = pcor.test(lf.data$nchars, lf.data$surprisal, lf.data$subt.log.freq, method = "spearman")$estimate
p.cor.surp.c = pcor.test(lf.data$nchars, lf.data$surprisal, lf.data$complexity)$estimate
p.cor.freq.bnc.s = pcor.test(lf.data$nchars, lf.data$log.bnc.frequency, lf.data$surprisal, method = "spearman")$estimate
p.cor.freq.subt.s = pcor.test(lf.data$nchars, lf.data$subt.log.freq, lf.data$surprisal, method = "spearman")$estimate
p.cor.freq.bnc.c = pcor.test(lf.data$nchars, lf.data$log.bnc.frequency, lf.data$complexity, method = "spearman")$estimate
p.cor.freq.subt.c = pcor.test(lf.data$nchars, lf.data$subt.log.freq, lf.data$complexity, method = "spearman")$estimate
...
# get correlations
full.piantadosi.df = rbind(tidy(cor.test(bnc.3gram$len, bnc.3gram$log.bnc.frequency, method = "spearman")),
                           tidy(cor.test(bnc.3gram$len, bnc.3gram$subt.log.freq, method = "spearman")),
                           tidy(cor.test(bnc.3gram$len, bnc.3gram$surprisal, method = "spearman")))
full.piantadosi.df$corr = c("freq.bnc", "freq.subt", "surprisal")
full.piantadosi.df$words = "all words"

# get partial correlations
full.p.cor.surp.f.bnc = pcor.test(bnc.3gram$len, bnc.3gram$surprisal, bnc.3gram$log.bnc.frequency, method = "spearman")$estimate
full.p.cor.surp.f.subt = pcor.test(bnc.3gram$len, bnc.3gram$surprisal, bnc.3gram$subt.log.freq, method = "spearman")$estimate
full.p.cor.freq.bnc.s = pcor.test(bnc.3gram$len, bnc.3gram$log.bnc.frequency,bnc.3gram$surprisal, method = "spearman")$estimate
full.p.cor.freq.subt.s = pcor.test(bnc.3gram$len, bnc.3gram$subt.log.freq,bnc.3gram$surprisal, method = "spearman")$estimate
full.partials = data.frame(p.corrs = c(full.p.cor.surp.f.bnc, full.p.cor.surp.f.subt, full.p.cor.freq.bnc.s, full.p.cor.freq.subt.s), 
                           corr =c("surprisal", "surprisal", "freq.bnc", "freq.subt"),
                           partialed = c("freq.bnc", "freq.subt", "surprisal", "surprisal"))
full.partials$words = "all words"
