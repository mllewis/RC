...
if (processNorms){
  ...
  one # 54 57 19 28 3 59 20 46 44 13 15 29
  two # 22 6  17 5 34 2 55 9 4 49 37 10
  three # 12 50 7 8 48 16 1 39 40 56 24 60
  four # 26 18 11 47 42 30 23 31 51 58 41 45
  five # 32 43 33 25 21 52 14 53 27 36 38 35
...
cg_norms$obj = as.factor(paste("\"", cg_norms$obj, "\"", sep = ""))
