...
if (doSlow){
  ...
  cg_norms = read.csv("data/norms/complicatedNormsGeons_BYITEM_exp1.csv") # Study 2
...
# write.csv(ms.chars2, "data/norms/complexNormsEnglish_BYWORD_exp9.csv")
...
The task can be found <a "href="https://mllewis.github.io/projects/RC/experiment17_2/ref_complex_17_2.html" target="_blank"> here</a>. Study 11 and Study 12 are not reported in the paper. 
